    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          Text('Monitor performance metrics and trends',
          ...
          LayoutBuilder(builder: (context, c) {
            ...
            if (wide) {
              return Row(
                children: [
                  Expanded(child: _metricCard('Conversion Rate', '3.24%', '+0.8%', Icons.trending_up_rounded, AppTheme.primaryColor)),
                  const SizedBox(width: 16),
                  Expanded(child: _metricCard('Avg Session', '4m 32s', '+12%', Icons.timer_rounded, const Color(0xFF8A2BE2))),
                  const SizedBox(width: 16),
                  Expanded(child: _metricCard('Bounce Rate', '24.1%', '-3.2%', Icons.exit_to_app_rounded, const Color(0xFFFFA726))),
                ],
              );
            } else {
              return Column(
          ...
          GlassCard(
            ...
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                const Text('Traffic Overview', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w600, color: Colors.white)),
                            ...
                            child: Container(
                              decoration: BoxDecoration(
                                gradient: LinearGradient(
                                  ...
                                  colors: [AppTheme.primaryColor.withValues(alpha: 0.15), AppTheme.primaryColor.withValues(alpha: 0.5)],
                                ),
    ...
    return GlassCard(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Row(children: [
          ...
          const Spacer(),
          Text(change, style: TextStyle(color: positive ? Colors.greenAccent : Colors.redAccent, fontWeight: FontWeight.w600, fontSize: 12)),
        ]),
