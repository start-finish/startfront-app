...
class DynamicWidgetData {
  ...
  // --- NEW: Direct Property Updater Method ---
  /// Updates a key/value pair in this widget's reactive properties map.
  void updateProperty(String key, dynamic value) {
    properties[key] = value;
    // RxMap handles reactivity, so this is all that's needed.
  }
